...
setup(
    name='tapioca-hubspot',
    version=get_version(package),
    description='hubspot API wrapper using tapioca',
    long_description=readme,
    author=get_author(package),
    author_email=get_email(package),
    url='https://github.com/timsmithenject/tapioca-hubspot',
    packages=[
        'tapioca_hubspot',
    ],
    package_dir={'tapioca_hubspot': 'tapioca_hubspot'},
